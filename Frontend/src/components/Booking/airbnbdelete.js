...
export default function Airbnbdelete() {
    const [Email,setemail] = useState("");
    const Del = async (e) => {
        e.preventDefault();
        const data = await Axios.post("http://localhost:5001/deleteairbnbbooking", {
            email: Email,   
        })
        if(data.data.msg){
    ...
    return (
        ...
        <div className="card">
            <div className="box">
        <h1>Welcome to Airbnb Booking Deletion Module</h1>
        <h6>Enter Details for the Airbnb Booking you want to deletion to your database</h6>
        <form>
        <div className="form">
